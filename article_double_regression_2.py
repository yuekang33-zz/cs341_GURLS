...
for i in xrange(len(step)-1):
    ...
    df_reshare_user = df_reshare_drop.groupby(['bizuin_md5','appmsgid','itemidx'],as_index = False).agg({'age':'mean','sex':'mean','education_level':'mean','friend_count':'mean','sendmsg_count':'mean','recvmsg_count':'mean','snsupload_count':'mean','sns_view':'mean'})
...
#filename = r'F:\academic\cs341\wechat\fh\labeled_distribution'
#df_distribution.to_csv(filename)    