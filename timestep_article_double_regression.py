...
#steps are time instead of cascade size
...
#get the reshare timepost ready, also create a time_eplased attribute for df_reshare
df_reshare['time_elapsed'] = df_reshare['reshare_timestamp']-df_reshare['posttime']
...
df_reshare_timestamp['time_elapsed'] = df_reshare['time_elapsed']
"""
